// require colorKeyWords array to check if input matches the accepted colors
...
const questions = [
    ...
    // ** SHAPE COLOR
    // choose either keyword or hexadecimal
    {
    ...
    // color keyword (validate with colorkeywaords array
     {
        type: "input",
        name: "shapeColor",
